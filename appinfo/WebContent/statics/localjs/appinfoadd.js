$(function(){  
	...
	$.ajax({
		type:"GET",//请求类型
		url:$("#basePath").val()+"/dev/app/flatform/",//请求的url
	...
	$.ajax({
		type:"GET",//请求类型
		url:$("#basePath").val()+"/dev/app/category1",//请求的url
		//data:{pid:null},//请求参数
		dataType:"json",//ajax接口（请求url）返回的数据类型
		success:function(data){//data：返回数据（json对象）
			$("#categoryLevel1").html("");
	...
	$("#categoryLevel1").change(function(){
		...
		if(categoryLevel1 != '' && categoryLevel1 != null){
			$.ajax({
				type:"GET",//请求类型
				url:$("#basePath").val()+"/dev/appcategory/categorylevellist/"+categoryLevel1,//请求的url
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			$.ajax({
				type:"GET",//请求类型
				url:$("#basePath").val()+"/dev/appcategory/categorylevellist/"+categoryLevel2,//请求的url
	...
	$("#APKName").bind("blur",function(){
		...
		if($("#APKName").val().trim() != ""  ){
			$.ajax({
				type:"POST",//请求类型
				url:$("#basePath").val()+"/dev/app/apkIsExists",//请求的url
