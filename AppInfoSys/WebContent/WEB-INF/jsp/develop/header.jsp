...
<title>APP开发者平台</title>
	...
	<link href="${basePath }/statics/css/dropzone.min.css" rel="stylesheet">
	<!-- Custom Theme Style -->
	<link href="${basePath }/statics/css/custom.min.css"	rel="stylesheet">
	
	<!-- add localcss 2016-8-18 -->
	<link href='${basePath }/statics/localcss/appinfoadd.css' rel='stylesheet'>
	<link href='${basePath }/statics/localcss/appinfolist.css' rel='stylesheet'>
</head>
			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${basePath}/dev/sys/main" class="site_title"><i class="fa fa-paw"></i> <span>APP
								BMS</span>
						</a>
					</div>
					...
					<div class="profile">
						<div class="profile_pic">
							<img
								src="${basePath }/statics/images/img.jpg"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${basePath}/dev/sys/applist">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="${basePath }/dev/loginout"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img
									src="${basePath }/statics/images/img.jpg"
									alt="">${userSession.devCode } <span
									class=" fa fa-angle-down"></span> </a>
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="${basePath }/dev/loginout"><i
